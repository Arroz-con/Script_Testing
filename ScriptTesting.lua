...
local function clickGuiButton(button)
    task.wait()
    VI:SendMouseButtonEvent(button.AbsolutePosition.X + 60, button.AbsolutePosition.Y + 100, 0, true, game, 1)
    task.wait(5)
    VI:SendMouseButtonEvent(button.AbsolutePosition.X + 60, button.AbsolutePosition.Y + 100, 0, false, game, 1)
    task.wait()
end
